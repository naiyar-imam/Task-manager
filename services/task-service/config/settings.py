...
def build_database_url():
    ...
    postgres_db = os.getenv("POSTGRES_DB", "task_service").strip()
    postgres_user = os.getenv("POSTGRES_USER", "postgres").strip()
    postgres_password = os.getenv("POSTGRES_PASSWORD", "").strip()
    postgres_host = os.getenv("POSTGRES_HOST", "task-db").strip()
...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "task-service-django-secret-key")
...
ALLOWED_HOSTS = get_env_list("ALLOWED_HOSTS", "task-service")
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "tasks.authentication.ServiceJWTAuthentication",
    ),
